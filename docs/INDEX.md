...
| [news-reporting-system.md](Features/UI/news-reporting-system.md) | News feeds and dispatch routing: event logging, combat summaries, period recaps, camp activity outcomes, compact Status glance, action-first Camp Hub, and single-page Reports view | ✅ Current |
