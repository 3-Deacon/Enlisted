...
| **Five-plan integration roadmap** 📋 Plan 1 drafted 2026-04-21 | [integration spec](superpowers/specs/2026-04-21-plans-integration-design.md) / [intelligence design](superpowers/specs/2026-04-21-enlisted-campaign-intelligence-design.md) / [Plan 1](superpowers/plans/2026-04-21-campaign-intelligence-backbone.md) | Merges Spec 2 remainder with Campaign Intelligence Backbone into five sequenced plans: Plan 1 (snapshot backbone, drafted), Plan 2 (lord AI wrappers, TBD), Plan 3 (signal projection, TBD), Plan 4 (duty opportunities + ambient pools + transitions, TBD), Plan 5 (career loop closure + polish, TBD). Plan 1 owns save-definer class offset 48 (see AGENTS.md Rule #11). |
