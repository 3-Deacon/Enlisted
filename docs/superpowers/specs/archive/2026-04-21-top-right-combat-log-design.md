...
**Date:** 2026-04-21
**Status:** Frozen design; implemented on `development`. Living reference: [docs/Features/Interface/enlisted-combat-log.md](../../Features/UI/enlisted-combat-log.md). Execution plan archived at [docs/superpowers/plans/archive/2026-04-21-top-right-combat-log.md](../plans/archive/2026-04-21-top-right-combat-log.md).
