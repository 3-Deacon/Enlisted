...
| 2 | Lord AI Intervention | ✅ Shipped 2026-04-22 (4929246→315b8ed, 22 commits) | Model wrappers (`TargetScoreCalculatingModel`, `ArmyManagementCalculationModel`, `MobilePartyAIModel`) + narrow Harmony for behavior loops. Snapshot-driven bias. Enlisted-gated. | 25 tasks (T24 in-game smoke pending human operator; T16-T18 Phase F narrow Harmony deferred pending smoke evidence) |
