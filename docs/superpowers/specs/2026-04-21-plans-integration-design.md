...
| 2 | Lord AI Intervention | ✅ Shipped 2026-04-22 (4929246→f289b9b) | Model wrappers (`TargetScoreCalculatingModel`, `ArmyManagementCalculationModel`, `MobilePartyAIModel`) + narrow Harmony for behavior loops. Snapshot-driven bias. Enlisted-gated. | All 25 tasks closed (Phase H smoke passed, Phase F narrow Harmony not required — see [plan2-phase-h-log.md](../../Features/CampaignIntelligence/plan2-phase-h-log.md)) |
