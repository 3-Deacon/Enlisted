...
- **[Order Progression System](order-progression-system.md)** - Chain of command directives: 16 orders across 3 tiers, strategic context filtering, success/failure resolution.
