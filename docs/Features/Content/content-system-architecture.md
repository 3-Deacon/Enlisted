...
> **LEGACY NOTICE (2026-04-19).** The pre-Spec-0 content surface described below — `EventDefinition`, `EventCatalog`, `DecisionCatalog`, `ContentOrchestrator`, `CampOpportunity` — is **scheduled for replacement** by surface specs 1-5. The replacement substrate (storylets, qualities, flags, activities) shipped as Spec 0 on 2026-04-19. New narrative work targets the new vocabulary, **not** the types documented below. Start here: [storylet-backbone.md](storylet-backbone.md) (living reference). The retired design spec with the deletion list (§15) identifying which legacy files disappear per surface spec is at [2026-04-19-storylet-backbone-design.md](../../superpowers/specs/2026-04-19-storylet-backbone-design.md).
